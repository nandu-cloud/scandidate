...
export class ExEmployeeService {
  ...
  savenowEmployee(empData): Observable<any> {
    ...
    } =
    {
      ...
      'originalFilename': empData.originalFilename == "" ? null : empData.originalFilename, 'status': true
    };
  ...
  savenowCandidate(empData): Observable<any> {
    ...
    empData.candidate.forEach(element => {
      cavArr.push({
        ...
        'employeeId': element.employeeId, 'role': element.role, 'status': true
      })
    });
  ...
  addcandidate(empData): Observable<any> {
    ...
    let bioobjj = {
      ...
      'hrorganisationId': organizationId, 'addedById': id, 'finalStatus': true
    }
  ...
  updateCandidate(candupdateData): Observable<any> {
    ...
    candupdateData.candidate.forEach(element => {
      cavArr.push({
        ...
        'discrepancyDocuments': element.discrepancyDocuments,
        'compliencyDiscrepancy': element.compliencyDiscrepancy,
        'warning': element.warning,
        'showCausedIssue': element.showCausedIssue,
