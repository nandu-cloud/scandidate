...
const ELEMENT_DATA: PeriodicElement[] = [
  ...
  {name:'During the recruitment process, prior to the background check process, we check the resume, social media profiles, references – everything is provided by the candidate!', name1:'Past employer and institutes provide the feedback – it can be checked any time, even before you interview the candidate.'},
  ...
  {name:'A BGV report captures data from the ex-employer much after the employee has left',name1:'SCANDIDATE data is captured at the time of exit – thus ensuring no feedback loss due to passage of time or changes in people '},
